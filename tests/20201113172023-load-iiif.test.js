...
const _20210413172023_load_iiif = rewire("../seeders/20201113172023-load-iiif")
const getSeeAlso = _20210413172023_load_iiif.__get__("getSeeAlso")
const parseIIIF = _20210413172023_load_iiif.__get__("parseIIIF")
const _20201113172023_load_iiif = rewire("../seeders/20201113172023-load-iiif")
// @ponicode
describe("getSeeAlso", () => {
    test("Valid data", () => {
...
describe("parseIIIF", () => {
    test("0", () => {
        ...
        let object = [{ DocumentId: 1, label: "Identifier", value: ["001AAN005126"], language: "none" }, { DocumentId: 1, label: "Title", value: ["Quartel Central do Corpo de Bombeiros"], language: "pt-br" }, { DocumentId: 1, label: "Description", value: ["Aspecto de uma das edificações do Corpo de Bombeiros. <br />\nFotografia integra &quot;Álbum de amador navegante &quot;, formado por 200 fotografias, que retratam uma viagem de navio pelo Brasil e por outros países da América do Sul e Central."], language: "pt-br" }, { DocumentId: 1, label: "Creator", value: ["Anônimo"], language: "none" }, { DocumentId: 1, label: "Date (Circa)", value: ["1905 – 1915"], language: "none" }, { DocumentId: 1, label: "Type", value: ["FOTOGRAFIA/ Papel"], language: "none" }, { DocumentId: 1, label: "Width", value: ["14.1"], language: "none" }, { DocumentId: 1, label: "Height", value: ["8.3"], language: "none" }]
